...
<head>
    ...
    <title>nTest - onlayn test topshirish platformasi</title>
                    ...
                    <div class="header-left rbt-header-content">
                        <div class="header-info">
                            <div class="logo logo-dark">
                                <a href="/">
                                    <img src="assets/images/Logo-Main.png" alt="nTest logo">
                                </a>
                            </div>
                        </div>
                            ...
                            <ul class="mainmenu">
                                ...
                                <li class="has-dropdown has-menu-child-item">
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li class="has-dropdown"><a href="#">Namunaviy topshiriqlar</a>
                                            <ul class="submenu">
                                        ...
                                        <li><a href="#">Ilmiy va statistik tahlillar</a>
                                        </li>
                                    </ul>
                                </li>
                    ...
                    <div class="header-right">
                        <div class="rbt-btn-wrapper d-none d-xl-block">
                            <a class="rbt-btn rbt-switch-btn btn-gradient btn-sm hover-transform-none" href="/login">
                                <span data-text="Tizimga kirish">Tizimga kirish</span>
                            </a>
                        </div>
        ...
        <div class="inner-wrapper">
            <div class="inner-top">
                <div class="content">
                    <div class="logo">
                        <div class="logo logo-dark">
                            <a href="/">
                                <img src="assets/images/Logo-Main.png" alt="Education Logo Images">
                            </a>
                        </div>
                    </div>
                ...
                <p class="description">Barcha fanlarga oid bilimni baholash bo‘yicha onlayn platforma.</p>
            </div>
            ...
            <div class="mobile-menu-bottom">
                <div class="rbt-btn-wrapper mb--20">
                    <a class="rbt-btn btn-border-gradient radius-round btn-sm hover-transform-none w-100 justify-content-center text-center" href="/login">
